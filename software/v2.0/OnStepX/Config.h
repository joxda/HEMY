...
// HEMY Tests
/*
:hF#:Te#:Td#:Sz180:00:00#:Sas00:00:00#:MA#
:hF#:Te#:Td#:Sr00:00:00#:Sds00:00:00#:CM#:hQ#:hP#
:hQ#:hP#    PARK here
:hP#        PARK
:hR#        PARK release
:R9#        SPEED x9
...
:SC12/13/24#:SL22:30:00#:SGs01#  // SET date + time + UTC offset
:hR#  // Release Park
:hF#:Te#:Td#     // Reset Home
:Sr11:05:16#:Sds61:36:41#:MS#     // Target Dubhe + Goto
:Sr09:57:37#:Sds68:56:34#:MS#     // Target Dubhe + Goto
:hC#     //Move to home

*/
// HEMY Config
#define DRIVER_TMC_STEPPER
#define DRIVER_TMC_STEPPER_HW_SPI
#define TMC2660_RSENSE 0.075F

#define SERIAL_A                Serial           // USB
#define SERIAL_B                Serial4          // ESP-01s
...
#define PPS_SENSE_PIN           5                // PPS time source, GPS for example
...
#define ADDON_RESET_PIN         23               // ESP8266 RST
...
#define SERIAL_C_BAUD_DEFAULT        9600 //    OFF, n. Baud rate as above. See (src/pinmaps/) for Serial port assignments.   Infreq
...
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ 
#define AXIS1_STEPS_PER_DEGREE  24888.889 // 35555.556 // 17777.778 //  12800, n. Number of steps per degree:                                          <-Req'd
...
// If runtime axis settings are enabled changes in the section below will be ignored (disable in SWS or by wiping NV/EEPROM):
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/
#define AXIS2_STEPS_PER_DEGREE  24888.889 // 26666.667 // 13333.333 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define PEC_STEPS_PER_WORM_ROTATION 89600 //128000//      0, n. Steps per worm rotation (0 disables else 720 sec buffer allocated.)  <-Req'd
...
#define SLEW_ACCELERATION_DIST        2.5 //    5.0, n, (degrees.) Approx. distance for acceleration (and deceleration.)      Adjust
#define SLEW_RAPID_STOP_DIST          1.5 //    2.0, n, (degrees.) Approx. distance required to stop when a slew              Adjust
